        ...
        <div className="px-4 md:px-8">
          ...
          <div className="bg-white mt-4 rounded-2xl shadow p-4 md:p-6 grid grid-cols-2 divide-x">
            <div>
              ...
              <p className="font-semibold">₹93.81</p>
            </div>
            <div className="pl-4">
              <p className="text-gray-500 text-sm">Our Price</p>
              <p className="font-semibold">₹98.20</p>
            </div>
          </div>
          ...
          <div className="mt-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {[ 
                { name: "Binance", price: "$1.00", change: "+0.02%", color: "text-green-500", bg: "bg-yellow-400" },
                { name: "Coinbase", price: "$0.999", change: "-0.01%", color: "text-red-500", bg: "bg-blue-500" },
                { name: "Kraken", price: "$1.001", change: "+0.01%", color: "text-green-500", bg: "bg-indigo-500" },
                { name: "KuCoin", price: "$1.00", change: "+0.00%", color: "text-green-500", bg: "bg-emerald-500" }
              ].map((item, i) => (
